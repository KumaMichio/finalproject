"""
Fine-tune YOLO11s on a VN-traffic detection dataset (5 classes:
...
Usage:
    python train_yolo_detector.py --data data/visdrone_carla_vn.yaml --epochs 50 \
        --batch 16 --out weights/yolo11s_vn.pt
...
The output checkpoint (weights/yolo11s_vn.pt by default) is picked up
...
def main():
    ...
    parser.add_argument('--out', default='weights/yolo11s_vn.pt')
    parser.add_argument('--project', default='runs/detect')
    parser.add_argument('--name', default='yolo11s_vn')
